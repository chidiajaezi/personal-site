  ...
  return (
    <>
      ...
      <section className="section" aria-labelledby="blog">
        ...
        <div className="list">
          <a href="/blog/scim-in-plain-english">
            <span>SCIM in Plain English: The protocol every IAM engineer should know</span>
            <span style={{fontSize:14}}>Read →</span>
          </a>
          <a href="/blog/saml-vs-oidc">
            <span>SAML vs OIDC: When to use which</span>
            <span style={{fontSize:14}}>Read →</span>
          </a>
          <a href="/blog/identity-as-code-terraform">
            <span>Identity as Code with Terraform</span>
            <span style={{fontSize:14}}>Read →</span>
          </a>
        </div>
      </section>
